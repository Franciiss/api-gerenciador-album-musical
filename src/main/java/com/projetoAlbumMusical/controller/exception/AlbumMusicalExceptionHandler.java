package com.projetoAlbumMusical.controller.exception;
...
@ControllerAdvice
public class AlbumMusicalExceptionHandler extends ResponseEntityExceptionHandler {

	private final MessageSource messageSource;

	@Autowired
	public AlbumMusicalExceptionHandler(MessageSource messageSource) {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex,
		...
		return super.handleExceptionInternal(ex, new Erro(mensagem, causa), new HttpHeaders(), HttpStatus.NOT_FOUND,
				request);
	...
	public ResponseEntity<Object> handleIllegalArgumentException(IllegalArgumentException ex, WebRequest request) {
		...
		return super.handleExceptionInternal(ex, new Erro(mensagem, causa), new HttpHeaders(), HttpStatus.BAD_REQUEST,
				request);
	}
